...
{
    public class DepartmentDbgController : Controller
    {
        ...
        // GET: DepartmentDbg/Create
        public ActionResult Create()
        {
            return View();
        }

        // POST: DepartmentDbg/Create
