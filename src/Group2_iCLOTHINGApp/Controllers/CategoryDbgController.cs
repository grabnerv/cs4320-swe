...
{
    public class CategoryDbgController : Controller
    {
        ...
        // GET: CategoryDbg/Create
        public ActionResult Create()
        {
            return View();
        }

        // POST: CategoryDbg/Create
